...
screen map_screen (aMap):
    ...
    if (rpg == True and commentFlag == False):
        ...
        if moving_up:
            timer 0.075 repeat True action [Function (room.moveDenizen, gray_sprite.x, gray_sprite.y, 0, -1), SetVariable ("g_dir", "back"), SetVariable ("move", "_move")]

        elif moving_down:
            timer 0.075 repeat True action [Function (room.moveDenizen, gray_sprite.x, gray_sprite.y, 0, 1), SetVariable ("g_dir", "front"), SetVariable ("move", "_move")]

        elif moving_left:
            timer 0.075 repeat True action [Function (room.moveDenizen, gray_sprite.x, gray_sprite.y, -1, 0), SetVariable ("g_dir", "left"), SetVariable ("move", "_move")]

        elif moving_right:
            timer 0.075 repeat True action [Function (room.moveDenizen, gray_sprite.x, gray_sprite.y, 1, 0), SetVariable ("g_dir", "right"), SetVariable ("move", "_move")]
